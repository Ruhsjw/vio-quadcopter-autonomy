...
class Vio():
    def __init__(self):
        ...
        noise_scale = float(os.environ.get("VIO_NOISE_SCALE", "1.0"))
        accelerometer_noise_density *= noise_scale
        accelerometer_random_walk *= noise_scale
        gyroscope_noise_density *= noise_scale
        gyroscope_random_walk *= noise_scale
        ...
        image_coord_std_dev = self.error_threshold * 0.1 * noise_scale
